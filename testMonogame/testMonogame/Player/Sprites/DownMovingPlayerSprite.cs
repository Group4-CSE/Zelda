...
{
    class DownMovingPlayerSprite : IAdvancedSprite
    {
        Texture2D texture;
        Rectangle destRect;
        ...
        public DownMovingPlayerSprite(Texture2D inTexture, IPlayerState inState)
        {
            ...
            frames.AddLast(new Rectangle(0, 0, 16, 16));
            frames.AddLast(new Rectangle(17, 0, 16, 16));
        ...
        {
            frames.AddFirst(new Rectangle(68, 17, 16, 16));
        }
        ...
        public void damageFlash()
        {
            ...
            frames.AddFirst(new Rectangle(170, 0, 16, 16));
            frames.AddFirst(new Rectangle(187, 0, 16, 16));
            frames.AddFirst(new Rectangle(170, 0, 16, 16));
            frames.AddFirst(new Rectangle(187, 0, 16, 16));
            frames.AddFirst(new Rectangle(170, 0, 16, 16));
            frames.AddFirst(new Rectangle(187, 0, 16, 16));
