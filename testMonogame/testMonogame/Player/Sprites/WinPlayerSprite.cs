...
{
    class WinPlayerSprite : IAdvancedSprite
    {
        Texture2D texture;
        Rectangle destRect;
        ...
        bool moving;
        public WinPlayerSprite(Texture2D inTexture, IPlayerState inState, int damageFramesRemaining)
        {
            texture = inTexture;
            state = inState;
            ...
            frames.AddLast(new Rectangle(154, 8, 14, 26));
            frames.AddLast(new Rectangle(154, 42, 14, 26));
